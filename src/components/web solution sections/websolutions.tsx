...
const HeroWebSolutions: React.FC = () => {
  return (
    <section className="relative overflow-hidden">
      {/* decorative soft blobs (percent-positioned so they scale) */}
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="absolute left-[5%] top-[26%] h-72 w-72 rounded-full bg-[#0022FF]/60 blur-[300px]" />
        <div className="absolute left-1/2 top-[28%] h-72 w-72 -translate-x-1/2 rounded-full bg-[#FF8952]/60 blur-[320px]" />
        <div className="absolute right-[3%] top-[10%] h-56 w-56 rounded-full bg-[#FF7230]/60 blur-[250px]" />
        <div className="absolute right-[6%] top-[21%] h-20 w-20 rounded-full bg-[#F88439] blur-[10px]" />
        <div className="absolute right-[7%] top-[28%] h-12 w-12 rounded-full bg-[#96D696] blur-[15px]" />
        <div className="absolute left-[2%] top-[38%] h-16 w-16 -rotate-[30deg] rounded-full bg-[#FFDC69] blur-[15px]" />
        <div className="absolute left-[10%] top-[44%] h-10 w-10 rotate-[25deg] rounded-full bg-[#FF6469] blur-[15px]" />
      </div>

      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 py-16 sm:py-20 lg:grid-cols-2">
        {/* left content */}
        <div className="space-y-7">
          <h1 className="font-montserrat text-4xl font-extrabold leading-tight tracking-tight text-[#003B5A] underline decoration-[#003B5A]/30 underline-offset-8 sm:text-5xl md:text-6xl">
            Web Solutions
          </h1>

          <p className="max-w-[65ch] font-montserrat text-base leading-7 text-black/60 sm:text-lg md:text-xl">
            Businesses big and small need a web presence outside of their brick-and-mortar establishment. If you want to
            create your online persona, our team is at your service. Royal Step Computer Solution brings you a complete
            portfolio of web solutions in Dubai at competitive rates.
          </p>

          <p className="max-w-[65ch] font-montserrat text-base leading-7 text-black/60 sm:text-lg md:text-xl">
            From web design and development to digital marketing, we offer you a complete package of advanced solutions
            delivered by a team of experienced professionals. Reach out for a free consultation today!
          </p>

          <div className="pt-2">
            <button
              type="button"
              className="group inline-flex items-center gap-3 rounded-full bg-[#003B5A] px-6 py-3 text-white transition hover:bg-[#064b73] focus:outline-none focus:ring-2 focus:ring-[#003B5A] focus:ring-offset-2"
            >
              See Services
              <svg
        ...
        <div className="relative">
          <img
            src="/api/placeholder/748/664"
            alt="Web dashboard on laptop"
            className="h-auto w-full max-w-3xl rounded-2xl border border-black/10 object-cover shadow-2xl"
          />

          {/* badge bottom-left */}
          <div className="absolute bottom-4 left-4 rounded-lg bg-[#003B5A] px-5 py-3 text-white shadow-lg">
            <div className="flex items-center gap-2 text-sm font-semibold">
              <svg className="h-5 w-5 text-blue-300" viewBox="0 0 20 20" fill="currentColor">
                <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4A1 1 0 013 6V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z" />
              </svg>
              Reliable Web Solutions in Dubai
            </div>
          </div>
          ...
          <img
            src="/api/placeholder/272/257"
            alt="Team collaboration"
            className="absolute -right-6 -top-6 hidden h-64 w-68 rounded-2xl border-4 border-white object-cover shadow-xl lg:block"
          />
        </div>
      </div>

      {/* subtle divider with tagline (optional) */}
      <div className="pb-8">
        <div className="mx-auto flex max-w-7xl items-center justify-center gap-4 px-4 text-slate-600">
          <div className="h-px w-12 bg-slate-400" />
          <span className="text-xs font-medium sm:text-sm">2017 – 863 Projects Completed</span>
          <div className="h-px w-12 bg-slate-400" />
        </div>
      </div>
    </section>
...
export default HeroWebSolutions;
